...
def get_session_token(session_token_code, auth_code_verifier):
    ...
    :param session_token_code:
    :param auth_code_verifier:
    :return:
    """
    nsoapp_version = get_nso_app_version()
...
def get_gtoken(f_gen_url, session_token):
    """
...
def get_bullet(web_service_token, web_view_ver, app_user_agent, user_lang, user_country):
    ...
    :param web_service_token:
    :param web_view_ver:
    :param app_user_agent:
    :param user_lang:
    :param user_country:
    :return:
    """
